...
class eb_commercial extends CI_Model
{
    ...
    public function supprimer_commercial($id)
    {

        return $this->db->delete('eb_commercial', array('id_com' => $id));
    }
    ...
    public function modifier_commercial($params)
    {
        ...
        return $this->db->update('eb_commercial', $this, array('id_com' => $params['id']));
    }
    ...
    public function selectionner_commercial($id) // fonction pour récupérer un commercial spécifique
    {
        return $this->db->get_where('eb_commercial', array('id_com'=>$id));  
    }
}
