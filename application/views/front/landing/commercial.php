...
<html lang="fr">
    <head>
        ...
        <meta name="twitter:title" content="Devenir Commercial" />
        <meta name="twitter:description" content="Deviens commercial pour le compte de l'Ecole 241 Business et fais-toi de l'argent gr&acirc;ce &agrave; tes aptitudes en communication." />
        ...
        <style tyle="text/css">
            ...
            .section.section--u51fm0br0i .color-1 {
                color: rgba(0, 51, 102, 1);
            }
            .section.section--u51fm0br0i {
                --color: rgba(0, 51, 102, 1);
            }
            .section.section--iw9mp97jzb .color-1 {
                color: rgba(255, 255, 255, 1);
            }
            .section.section--iw9mp97jzb {
                --color: rgba(255, 255, 255, 1);
            }
            .section.section--hh6bb5mr538 .color-1 {
                color: rgba(0, 51, 102, 1);
            }
            .section.section--hh6bb5mr538 {
                --color: rgba(0, 51, 102, 1);
            }
            .section.section--2c8bgs11don .color-1 {
                color: rgba(0, 51, 102, 1);
            }
            .section.section--2c8bgs11don {
                --color: rgba(0, 51, 102, 1);
            }
            .section.section--5o4nnf7wd86 .color-1 {
                color: rgba(0, 51, 102, 1);
            }
            .section.section--5o4nnf7wd86 {
                --color: rgba(0, 51, 102, 1);
            }
    ...
    <body>
        ...
        <div id="feature" class="section section--feature section--noPadding section--left dark section--u51fm0br0i" style="background-color: #fff; --pdx-min-height: 500px; --wr-max: 1200px;">
                ...
                <div class="ft__half">
                    <div class="ft__wrapper" style="max-width: 570px;">
                        <div class="ft__content">
                            <h1 class="color-1 weight-title-h font-title section__title left noMargin">DEVIENS COMMERCIAL POUR L'ECOLE 241 BUSINESS</h1>
                            <p class="weight-text section__subtitle left noMargin">
                                Participe &agrave; l&rsquo;&eacute;closion du commerce en ligne au Gabon et &agrave; la transformation digitale des petites entreprises tout en gagnant de l&rsquo;argent en tant que commercial
                            </p>
                        </div>
                    </div>
                </div>
                <div class="ft__half pdx pdxParent--img-solid" style="--pdx-maxheight: 1;">
                    <div class="pdxItem pdxItem--img-solid" style="border-radius: 5px; box-shadow: 0 10px 25px 0 rgba(0, 0, 0, 0.2);">
                        <img
                            src="<?= theme_url() ?>images/assets-xqt7y28l.png"
                            srcset="https://landen.imgix.net/j5m8fgybln8l/assets/xqt7y28l.png?w=1200&amp;h=900&amp;fit=max, https://landen.imgix.net/j5m8fgybln8l/assets/xqt7y28l.png?w=1200&amp;h=900&amp;fit=max&amp;dpr=2 2x"
                            alt="8 (2).png"
                        />
                    </div>
                </div>
        ...
        <div
            id="titles"
            class="section section--titles section--center section--iw9mp97jzb"
            style="background-color: rgba(0, 51, 102, 1); padding-bottom: 60px; padding-top: 60px; --pdx-min-height: 0px; --wr-max: 1200px; color: rgba(255, 255, 255, 1);"
        >
            ...
            <div class="wr"><h2 class="color-1 weight-title-h font-title section__title center standalone">Gagne de l&rsquo;argent sans bouger de chez toi en devenant commercial.</h2></div>
        </div>
        <div id="gallery" class="section section--gallery section--center dark section--hh6bb5mr538" style="background-color: #fff; padding-bottom: 60px; padding-top: 60px; --pdx-min-height: 0px; --wr-max: 1200px;">
            <div class="wr">
                <h2 class="color-1 weight-title-h font-title section__title center standalone">LES AVANTAGES D'ETRE UN COMMERCIAL</h2>
                    ...
                    <div class="galleryItem" style="width: calc(33.33% - 30px); margin: 0 15px 30px; border-radius: 5px; box-shadow: 0 10px 25px 0 rgba(0, 0, 0, 0.2); margin-top: 0 15px 30px; margin-bottom: 0 15px 30px;">
                        <div target="">
                            ...
                            <div class="gallery__meta">
                                ...
                                <div class="gallery__description" style= "text-align: center;">Soit 15.000 Fcfa par apprenant.</div>
                            </div>
                        </div>
                    </div>
                    <div class="galleryItem" style="width: calc(33.33% - 30px); margin: 0 15px 30px; border-radius: 5px; box-shadow: 0 10px 25px 0 rgba(0, 0, 0, 0.2); margin-top: 0 15px 30px; margin-bottom: 0 15px 30px;">
                        <div target="">
                            ...
                            <div class="gallery__meta">
                                ...
                                <div class="gallery__description" style= "text-align: center;">Exceptionnel pour les meilleurs vendeurs.</div>
                            </div>
                        </div>
                    </div>
                    <div class="galleryItem" style="width: calc(33.33% - 30px); margin: 0 15px 30px; border-radius: 5px; box-shadow: 0 10px 25px 0 rgba(0, 0, 0, 0.2); margin-top: 0 15px 30px; margin-bottom: 0 15px 30px;">
                        <div target="">
                            ...
                            <div class="gallery__meta">
                                ...
                                <div class="gallery__description" style= "text-align: center;">Un acc&egrave;s &agrave; la formation acc&eacute;l&eacute;r&eacute; de la vente en ligne.</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="gallery" class="section section--gallery section--center dark section--2c8bgs11don" style="background-color: #fff; padding-bottom: 60px; padding-top: 60px; --pdx-min-height: 0px; --wr-max: 1200px;">
            <div class="wr">
                <h2 class="color-1 weight-title-h font-title section__title center standalone">COMMENT SE FAIRE PAYER ?</h2>
                <div class="gallery" style="margin: 0 -15px -30px; margin-top: 0 -15px -30px; margin-bottom: 0 -15px -30px;">
        ...
        <div id="hero" class="section section--hero section--noPadding section--left dark section--5o4nnf7wd86" style="background-color: #fff; --pdx-min-height: 700px; --wr-max: 1200px;">
            <div class="ft ft--left" style="--pdx-pt: 0; --pdx-pb: 0;">
                <div class="ft__half">
                    <div class="ft__wrapper" style="max-width: 570px;">
                        <div class="ft__content">
                            ...
                            <p class="hero__subtitle weight-text">
                                L&rsquo;&eacute;cole 241, est la premi&egrave;re fabrique Simplon au Gabon, enti&egrave;rement gratuite, ouverte et accessible &agrave; tous. Sa m&eacute;thode d&rsquo;enseignement s&rsquo;inspire des plus
                                grandes &eacute;coles du num&eacute;rique, qui est la p&eacute;dagogie invers&eacute;e .
                            </p>
                            <div class="ctas">
        ...
        <div style="position: relative;">
            <a href="https://www.landen.co/?utm_source=litebadge" class="footerBadge footerBadge--production">Made with <span>Landen</span></a>
        </div>
        <script>
            !(function () {
                function e() {
