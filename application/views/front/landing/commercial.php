...
<head>
    ...
    <meta name="description"
        content="Deviens commercial pour le compte de l'Ecole 241 Business et fais-toi de l'argent gr&acirc;ce &agrave; tes aptitudes en communication." />
    ...
    <meta name="og:url"
        content="https://business.ecole241.org/index.php/partage/7b52009b64fd0a2a49e6d8a939753077792b0554" />
    <meta name="og:site_name" content="Ecole 241 Business">
    <meta name="og:description"
        content="Ecole 241 Business est une école de formation pour les commer&ccedil;ants et artisans aux m&eacute;tiers du num&eacute;rique..">
...
<body>
    <header id="header" class="section header dark header--fixed header--solid"
        style="background-color: #fff; border-color: rgba(0, 0, 0, 0.1); --wr-max: 1200px; color: rgba(0, 51, 102, 1);">
        <div class="wr color-1" style="margin-top: 10px; margin-bottom: 10px;">
            <nav id="headerNav">
                <a id="headerLogo" href="ecole-241-business-accueil.html" class="header__logoImg"><img
                        src="<?= theme_url() ?>images/logoecole241.png" width="160"
                        alt="Logo-officiel-E-241-Business-Transparent (1).png" /></a>
                <div class="spacer"></div>
                <div class="headerNav__links"></div>
                <!-- Icônes des réseaux sociaux -->
                <div class="header__navCtas" style="margin-right: 35%;">
                    <!-- Icône pour Linkedin dans le header -->
                    <a href="https://www.linkedin.com/company/business-ecole241" class="btn btn--c btn--secondary"
                        style="color: #ffffff;">
                        <img src="https://img.icons8.com/fluent/30/000000/linkedin.png" />
                    </a>
                    <!-- Icône pour Facebook dans le header -->
                    <a href="https://www.facebook.com/ecole-241-business-101322485115490"
                        class="btn btn--c btn--secondary" style="color: #ffffff;">
                        <img src="https://img.icons8.com/fluent/30/000000/facebook-new.png" />
                    </a>
                </div>
                <div class="header__navCtas">
                    <a href="<?= site_url('commercial/inscription') ?>" class="btn btn--c btn--primary"
                        style="color: rgba(255, 255, 255, 1); background-color: rgba(255, 51, 51, 1);">
                        Je me lance
                    ...
                    <a href="<?= site_url('commercial') ?>" class="btn btn--c btn--primary"
                        style="color: rgba(255, 51, 51, 1); border: 1px solid  rgba(255, 51, 51, 1);">
                        Se connecter
                    </a>
                </div>
    ...
    <div id="feature" class="section section--feature section--noPadding section--left dark section--u51fm0br0i"
        ...
        <div class="ft ft--left" style="--pdx-pt: 0; --pdx-pb: 0;">
            <div class="ft__half">
                <div class="ft__wrapper" style="max-width: 570px;">
                    ...
                    <div class="ctas">
                        <a href="<?= site_url('commercial/inscription') ?>" class="btn btn--c btn--primary btn--large"
                            style="color: rgba(255, 255, 255, 1); background-color: rgba(255, 51, 51, 1);">
                            Je me lance
                            <svg width="13" height="12" xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            <div class="ft__half pdx pdxParent--img-solid" style="--pdx-maxheight: 1;">
                <div class="pdxItem pdxItem--img-solid"
                    style="border-radius: 5px; box-shadow: 0 10px 25px 0 rgba(0, 0, 0, 0.2);">
                    <img src="<?= theme_url() ?>images/assets-xqt7y28l.png"
    ...
    <div id="titles" class="section section--titles section--center section--iw9mp97jzb"
    ...
    <div id="gallery" class="section section--gallery section--center dark section--hh6bb5mr538"
        ...
        <div class="wr">
            ...
            <div class="gallery"
                style="margin: 0 -15px -30px; margin-top: 0 -15px -30px; margin-bottom: 0 -15px -30px;">
                <div class="galleryItem"
                    style="width: calc(33.33% - 30px); margin: 0 15px 30px; border-radius: 5px; box-shadow: 0 10px 25px 0 rgba(0, 0, 0, 0.2); margin-top: 0 15px 30px; margin-bottom: 0 15px 30px;">
                    <div target="">
                        <div class="media"><img src="<?= theme_url() ?>images/assets-c8asf0bf.png"
                                srcset="https://landen.imgix.net/j5m8fgybln8l/assets/c8asf0bf.png?w=800&amp;h=400&amp;fit=crop 2x"
                                alt="" /></div>
                ...
                <div class="galleryItem"
                    style="width: calc(33.33% - 30px); margin: 0 15px 30px; border-radius: 5px; box-shadow: 0 10px 25px 0 rgba(0, 0, 0, 0.2); margin-top: 0 15px 30px; margin-bottom: 0 15px 30px;">
                    <div target="">
                        <div class="media"><img src="<?= theme_url() ?>images/assets-oaa6kvq3.png"
                                srcset="https://landen.imgix.net/j5m8fgybln8l/assets/oaa6kvq3.png?w=800&amp;h=400&amp;fit=crop 2x"
                                alt="" /></div>
                        <div class="gallery__meta">
                ...
                <div class="galleryItem"
                    style="width: calc(33.33% - 30px); margin: 0 15px 30px; border-radius: 5px; box-shadow: 0 10px 25px 0 rgba(0, 0, 0, 0.2); margin-top: 0 15px 30px; margin-bottom: 0 15px 30px;">
                    <div target="">
                        <div class="media"><img src="<?= theme_url() ?>images/assets-t7jqsrnl.png"
                                srcset="https://landen.imgix.net/j5m8fgybln8l/assets/t7jqsrnl.png?w=800&amp;h=400&amp;fit=crop 2x"
                                alt="" /></div>
                        <div class="gallery__meta">
    ...
    <div id="gallery" class="section section--gallery section--center dark section--2c8bgs11don"
        style="background-color: #003366; padding-bottom: 60px; padding-top: 60px; --pdx-min-height: 0px; --wr-max: 1200px;">
        <div class="wr">
            ...
            <div class="gallery"
                style="margin: 0 -15px -30px; margin-top: 0 -15px -30px; margin-bottom: 0 -15px -30px;">
                <div class="galleryItem"
                    style="width: calc(50% - 30px); margin: 0 15px 30px; border-radius: 5px; box-shadow: 0 10px 25px 0 rgba(0, 0, 0, 0.2); margin-top: 0 15px 30px; margin-bottom: 0 15px 30px;">
                    <div target="">
                        <div class="media"><img src="<?= theme_url() ?>images/assets-g65p53rd.png"
                                srcset="https://landen.imgix.net/j5m8fgybln8l/assets/g65p53rd.png?w=1200&amp;h=400&amp;fit=crop 2x"
                                alt="" /></div>
                        <div class="gallery__meta">
                ...
                <div class="galleryItem"
                    style="width: calc(50% - 30px); margin: 0 15px 30px; border-radius: 5px; box-shadow: 0 10px 25px 0 rgba(0, 0, 0, 0.2); margin-top: 0 15px 30px; margin-bottom: 0 15px 30px;">
                    <div target="">
                        <div class="media"><img src="<?= theme_url() ?>images/assets-acsp3mbj.png"
                                srcset="https://landen.imgix.net/j5m8fgybln8l/assets/acsp3mbj.png?w=1200&amp;h=400&amp;fit=crop 2x"
                                alt="" /></div>
                        <div class="gallery__meta">
    ...
    <div id="hero" class="section section--hero section--noPadding section--left dark section--5o4nnf7wd86"
        style="background-color: #fff; --pdx-min-height: 700px; --wr-max: 1200px;">
        <div class="ft ft--left" style="--pdx-pt: 0; --pdx-pb: 0;">
            <div class="ft__half">
                <div class="ft__wrapper" style="max-width: 570px;">
                    <div class="ft__content">
                        ...
                        <div class="ctas">
                            <a href="<?= site_url('commercial/inscription') ?>"
            ...
            <div class="ft__half pdx pdxParent--img-transparent" style="--pdx-maxheight: 1;">
                <iframe class="media media--image" srcset="https://landen.imgix.net/j5m8fgybln8l/assets/swnva0co.png 2x"
                    style="display: block;" ;
    ...
    <footer id="footer" class="section section--footer section--center section--8hhhlpkfre2"
        style="background-color: rgba(0, 51, 102, 1); padding-bottom: 15px; padding-top: 15px; --pdx-min-height: 0px; --wr-max: 1200px;">
        <div class="wr">
            <div class="footer footer--simple">
                <div class="footer__primary">
                    <span>&copy; 2020 Ecole 241 Business</span> <br>
                    <span>(+241) 62 13 07 07 | contact@business.ecole241.org</span>
                    <nav class="footer__linkRow"><a href="devenir-commercial.html">Programme d'affiliation</a><a
                            href="<?= site_url('commercial/inscription') ?>">S'inscrire</a></nav>
                </div>
