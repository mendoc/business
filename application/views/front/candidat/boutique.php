                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-4 text-center">
                                    <img src="<?= theme_url() ?>demo/products/apple-iphone7-special.jpg" alt="Apple iPhone 7 128GB" class="img-fluid">
                                </div>
                    ...
                    <div class="col-md-6 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="mb-4 text-center">
                                    <img src="<?= theme_url() ?>demo/products/gopro-hero.jpg" alt="Apple iPhone 7 128GB" class="img-fluid">
                                </div>
            ...
            <div class="col-lg-9">
                <div class="card">
                    <table class="table card-table table-vcenter">
                        <tr>
                            <td><img src="<?= theme_url() ?>demo/products/apple-iphone7-special.jpg" alt="" class="h-8"></td>
                            <td>
                        ...
                        <tr>
                            <td><img src="<?= theme_url() ?>demo/products/apple-macbook-pro.jpg" alt="" class="h-8"></td>
                            <td>
                        ...
                        <tr>
                            <td><img src="<?= theme_url() ?>demo/products/apple-iphone7.jpg" alt="" class="h-8"></td>
                            <td>
                        ...
                        <tr>
                            <td><img src="<?= theme_url() ?>demo/products/gopro-hero.jpg" alt="" class="h-8"></td>
                            <td>
                                GoPro HERO6 Black
                                <div class="badge badge-default badge-md">New</div>
                            </td>
                        ...
                        <tr>
                            <td><img src="<?= theme_url() ?>demo/products/msi.jpg" alt="" class="h-8"></td>
                            <td>
                        ...
                        <tr>
                            <td><img src="<?= theme_url() ?>demo/products/xiaomi-mi.jpg" alt="" class="h-8"></td>
                            <td>
                        ...
                        <tr>
                            <td><img src="<?= theme_url() ?>demo/products/huawei-mate.jpg" alt="" class="h-8"></td>
                            <td>
                        ...
                        <tr>
                            <td><img src="<?= theme_url() ?>demo/products/sony-kd.jpg" alt="" class="h-8"></td>
                            <td>
                                Sony KD-49XE7005
                                <div class="badge badge-default badge-md">New</div>
                            </td>
                        ...
                        <tr>
                            <td><img src="<?= theme_url() ?>demo/products/samsung-galaxy.jpg" alt="" class="h-8"></td>
                            <td>
