	...
	<div class="container">
		...
		<div class="left">
			...
			<form class="form">
				...
				<input type="number" name="numero" class="form-field animation a3" placeholder="Numéro de téléphone Ex. 077 01 89 00">
				<input type="number" name="numero" class="form-field animation a3" placeholder="Numéro de téléphone WhatsApp Ex. 077 01 89 00">
		
				<fieldset>
					<label for="horaire">Horaire</label>
					<input type="radio" name="horaire"><label for="horaire">Matin</label>
					<input type="radio" name="horaire"><label for="horaire">Après-midi</label>
				</fieldset>

				<input type="text" name="domain" class="form-field animation a3" placeholder="Votre domaine d’activité Ex. Artisanat">
