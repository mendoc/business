...
">
    ...
    border: solid white;">
        ...
        margin: 0 auto;">
            ...
            <p style=" margin-top: 30px;
            margin-bottom: 20px;font-size: 1.3rem; word-wrap: break-word;">Lien de connexion : https://business.ecole241.org/gestionnaire</p>
            <p style="margin-top: 20px;
        ...
        ;" href="https://business.ecole241.org/gestionnaire">Accéder au tableau de bord</a>
            <!--# le message 4 #--->
